...
def parse_args():
    ...
    if args.optimizer == "adam8bit" and bnb is None:
...
def main():
    ...
    accelerator = Accelerator(
        ...
        mixed_precision="fp16",  # Added from previous request for FP16 precision
        **accelerator_log_kwargs
    )
    ...
    if args.optimizer == "adafactor":
        ...
        if bnb is None:
            raise ValueError("bitsandbytes library is required for 8-bit Adam but is not installed.")
